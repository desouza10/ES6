...
console.log(nome);
console.log(resto); //Outro Exemplo:
...
console.log(a);
console.log(b);
console.log(c); //Exemplo com function()
...
console.log(soma(1, 3, 4)); //SPREAD Operations: permite uma expressão ser expandida em locais onde múltiplos argumentos (por chamadas de função) ou múltiplos elementos (por array literais) são esperados.
